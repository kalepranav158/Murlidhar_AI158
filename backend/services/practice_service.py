...
import numpy as np
import logging
from backend.services.adaptive_engine import build_snapshot, generate_adaptive_plan
from backend.services.analytics_engine import compute_analytics
from backend.services.llm.feedback_llm import generate_guru_feedback, generate_normal_feedback
from backend.utils.music.song_loader import infer_content_type, load_song
...
from backend.services.alankar_engine import compute_alankar_level
from backend.services.song_engine import generate_song_adaptive_plan
from backend.services.practice_endpoint.audio_core import process_audio_core
from backend.utils.audio.techniques import compare_with_reference
...
async def evaluate_alankar(
    ...
    # Load alankar JSON
    song_path = f"data/songs/catalog/{alankar_id}.json"
