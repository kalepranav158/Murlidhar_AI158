...
from backend.utils.analytics.progress import compute_progress
from backend.utils.llm.feedback import generate_feedback
...
def main():
    ...
    if len(played) < 3:
        print("âŒ Too few notes detected. Try again.")
        return
